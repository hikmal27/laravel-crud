                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="{{ asset('PurpleAdmin/assets/images/faces/face1.jpg') }}" class="mr-2" alt="image"> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{ asset('PurpleAdmin/assets/images/faces/face2.jpg') }}" class="mr-2" alt="image"> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="{{ asset('PurpleAdmin/assets/images/faces/face3.jpg') }}" class="mr-2" alt="image"> Marina Michel
                            </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pr-1">
                        <img src="{{ asset('PurpleAdmin/assets/images/dashboard/img_1.jpg') }}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{ asset('PurpleAdmin/assets/images/dashboard/img_4.jpg') }}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 pl-1">
                        <img src="{{ asset('PurpleAdmin/assets/images/dashboard/img_2.jpg') }}" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="{{ asset('PurpleAdmin/assets/images/dashboard/img_3.jpg') }}" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="{{ asset('PurpleAdmin/assets/images/faces/face3.jpg') }}" class="img-sm rounded-circle mr-3" alt="image">

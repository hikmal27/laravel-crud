...
<html lang="en">
  ...
  <body>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="post" action="/table/{{ $form->id }}" class="forms-sample">
                     {{ csrf_field() }}
                      @if (session('status'))
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" id="exampleInputName1" placeholder="Name" value="{{ $form->name }}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Email address</label>
                        <input type="email" name="email" class="form-control" id="exampleInputEmail3" placeholder="Email" value="{{ $form->email }}">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Password</label>
                        <input type="password" name="password" class="form-control" id="exampleInputPassword4" placeholder="Password" value="{{ $form->password }}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="city" class="form-control" id="exampleInputCity1" placeholder="Location" value="{{ $form->city }}">
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1" >Textarea</label>
                        <textarea class="form-control" name="textarea" id="exampleTextarea1" rows="4">{{ $form->textarea }}</textarea>
                      </div>
    ...
    <script src="{{ asset('PurpleAdmin/') }}../../assets/js/file-upload.js"></script>
